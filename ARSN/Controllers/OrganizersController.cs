...
namespace ARSN.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrganizerID,Name,Surname,Email,BirthDate,Organisation,PhoneNumber,Gender,Password")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("OrganizerID,Name,Surname,Email,BirthDate,Organisation,PhoneNumber,Gender,Password")] Organizer organizer)
        {
